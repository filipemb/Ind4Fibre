...
public class Sala implements Serializable
{
    ...
    private final static long serialVersionUID = -1806538167992238648L;
     ...
     * @param timestamp
     */
    public Sala(String id, LocalDateTime timestamp, String topic, BigDecimal value) {
        super();
        this.id = id;
    ...
    public Sala withTimestamp(LocalDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public Sala withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public Sala withValue(BigDecimal value) {
        this.value = value;
        return this;
    }
    ...
    public Sala withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sala) == false) {
            return false;
        }
        Sala rhs = ((Sala) other);
