...
public class Armazenamento implements Serializable
{
    ...
    private final static long serialVersionUID = 8386589893464989662L;
     ...
     * @param timestamp
     */
    public Armazenamento(String id, LocalDateTime timestamp, String topic, BigDecimal value) {
        super();
        this.id = id;
    ...
    public Armazenamento withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Armazenamento withTimestamp(LocalDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public Armazenamento withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public Armazenamento withValue(BigDecimal value) {
        this.value = value;
        return this;
    }
    ...
    public Armazenamento withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Armazenamento) == false) {
            return false;
        }
        Armazenamento rhs = ((Armazenamento) other);
