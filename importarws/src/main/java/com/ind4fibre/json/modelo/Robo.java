...
public class Robo implements Serializable
{
    ...
    private final static long serialVersionUID = -1407009963958142616L;
     ...
     * @param timestamp
     */
    public Robo(String id, LocalDateTime timestamp, String topic, BigDecimal value) {
        super();
        this.id = id;
    ...
    public Robo withTimestamp(LocalDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public Robo withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public Robo withValue(BigDecimal value) {
        this.value = value;
        return this;
    }
    ...
    public Robo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Robo) == false) {
            return false;
        }
        Robo rhs = ((Robo) other);
