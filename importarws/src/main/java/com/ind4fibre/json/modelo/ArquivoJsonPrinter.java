...
public class ArquivoJsonPrinter implements Serializable
{
     ...
     * @param imp3D
     */
    public ArquivoJsonPrinter(List<Armazenamento> armazenamento, List<Imp3D> imp3D, List<Sala> sala) {
        super();
    ...
    public ArquivoJsonPrinter withArmazenamento(List<Armazenamento> armazenamento) {
        this.armazenamento = armazenamento;
        return this;
    }
    ...
    public ArquivoJsonPrinter withImp3D(List<Imp3D> imp3D) {
        this.imp3D = imp3D;
        return this;
    }
    ...
    public ArquivoJsonPrinter withSala(List<Sala> sala) {
        this.sala = sala;
        return this;
    }
    ...
    public ArquivoJsonPrinter withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ArquivoJsonPrinter) == false) {
            return false;
        }
        ArquivoJsonPrinter rhs = ((ArquivoJsonPrinter) other);
